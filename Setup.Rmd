...
All.steps_Dictionaries = read.csv("C:\\Users\\Gandalf\\Dropbox\\Dictionary creation Project\\Large Dictionaries 120321.csv", stringsAsFactors = F) 
Dictionaries = read.csv("C:\\Users\\Gandalf\\Dropbox\\Dictionary creation Project\\Preprocessed Only Dictionaries 120321.csv", stringsAsFactors = F) 
...
Seed_Vectors_Avg = read.csv("C:\\Users\\Gandalf\\Dropbox\\Dictionary creation Project\\Seed vectors Average 080221.csv", stringsAsFactors = F)
Seed_Vectors_personcontext_Avg = read.csv("C:\\Users\\Gandalf\\Dropbox\\Dictionary creation Project\\Seed vectors person context Average 080221.csv", stringsAsFactors = F)
...
All.steps_Dictionaries = read.csv("D:\\Dropbox\\Dictionary creation Project\\Large Dictionaries 120321.csv", stringsAsFactors = F) 
Dictionaries = read.csv("D:\\Dropbox\\Dictionary creation Project\\Preprocessed Only Dictionaries 120321.csv", stringsAsFactors = F) 
...
```{r}
usethis::use_vignette("Dictionary_Creation_Example_Guide")
