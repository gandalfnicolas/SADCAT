...
# Load dictionaries: Using the most extensive dictionaries here.
...
# Stem (If you prefer the text to not be stemmed, skip this step, and also skip the stemming step for your data later on)

toks <- quanteda::tokens(Pre_Dictionaries$values0, remove_numbers = T, remove_punct = T, remove_symbols = T)
...
#Create direction indicators: Positive scores indicate text is more high (vs. low) directional, negative scores indicate the text is more low (vs. high) directional, for each dimension tested. This code can be modified to create other indicators (e.g., for valence subtract _neg from _pos variables.).
