...
#2:  Load dictionaries: All.steps_Dictionaries is the complete, corrected dictionary dataset (as of SADCAT 2.0.0 it is the only dictionary dataset shipped with the package).
...
#15: Write data
write.csv(toks_dict, "obituaries_dict.csv")
